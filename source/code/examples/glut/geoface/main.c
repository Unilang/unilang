...
faceinit ( void )
{
  face = create_face         ( "code/examples/glut/geoface/index.dat", "code/examples/glut/geoface/faceline.dat") ;
  read_muscles               ("code/examples/glut/geoface/muscle.dat", face ) ;
  read_expression_vectors    ("code/examples/glut/geoface/expression-vectors.dat", face ) ;
  data_struct                ( face ) ;	
}
